...
exports.BattleStateManager = void 0;
class BattleStateManager {
    state;
    websocket;
    calcServiceUrl;
    policyServiceUrl;
    constructor(websocket, calcServiceUrl = 'http://localhost:3001', policyServiceUrl = 'http://localhost:8000') {
    ...
    async getPolicyRecommendation(calcResults) {
        try {
    ...
    updateFromShowdownMessage(message) {
    ...
    applySafetyLayer(action, legalActions) {
        // Never Struggle
    ...
    shouldPreserveRoleHolder(action) {
